...
class Res2Net(nn.Module):
    ...
    def __init__(self, block, layers, baseWidth=26, scale=4, num_classes=None, out_features=None):
        ...
        self.OutputNamedTupleFactory = namedtuple("Output", ("stem", "res3", "res4", "res5"))
        ...
        self._out_feature_channels['res5'] = 64 * 4
    ...
    def forward(self, x):
        ...
        if self.num_classes:
            ...
            # return self.OutputNamedTupleFactory(stem=stem, res3=res3, res4=res4, res5=res5)
            return res5
...
if __name__ == '__main__':
    ...
    print(len(model(images)))
    print(model(images)[0].shape)
    print(model(images)[1].shape)
    print(model(images)[2].shape)
    print(model(images)[3].shape)